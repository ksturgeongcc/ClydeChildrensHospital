            ...
            <div class="p-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-blue-800">
              <div class="container mx-auto w-full flex flex-wrap justify-between mx-2">
                ...
                <ul class="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
                  ...
                  <p class="text-gray-100 text-sm"><?= $apptTitle ?></p>
                  <?php else : ?>
                    <p class="text-gray-100 text-sm">Your appointment has not been set. Check back later.</p>
                    <?php endif ?>
                  <div class="flex items-center py-3">
                    ...
                    <a href="appointments" class="text-white bold border-b-2 border-blue-300 hover:text-blue-300">Find out more...</a>
                  </div>
                </ul>
